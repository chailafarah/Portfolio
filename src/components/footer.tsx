      ...
      <div className="container px-4 py-8 mx-auto">
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-4">
            <a className="text-gray-600 dark:text-white hover:text-gray-950" href="https://github.com/chailafarah" target="_blank">
            ...
            <a className="text-gray-600 dark:text-white hover:text-gray-950" href="https://www.linkedin.com/in/chaimaafaris/" target="_blank">
