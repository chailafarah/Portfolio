          ...
          <div key={project.id} className={
            ...
            <div className="p-6 md:p-12">
              ...
              <div className="gap-3 inline-flex flex-col">
                {project.figma && (
                  <a className="gap-2 inline-flex items-center justify-center rounded-full px-8 py-1 ring-1 ring-gray-950/10 dark:ring-gray-500 hover:ring-gray-950/20 hover:dark:ring-gray-400" href={project.figma} target="_blank">
                ...
                {project.github && (
                  <a className="gap-2 inline-flex items-center justify-center rounded-full px-8 py-1 ring-1 ring-gray-950/10 dark:ring-gray-500 hover:ring-gray-950/20 hover:dark:ring-gray-400" href={project.github} target="_blank">
